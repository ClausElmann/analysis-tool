...
[void]$rm.AppendLine("6. Laes analysis-tool/ai-governance/AI_BUILDER_ARCHITECT_PROTOCOL.md -- samarbejdsregler")
[void]$rm.AppendLine("")
...
[void]$rm.AppendLine("| green-ai/AI_STATE.md | L2 | Nuvaerende systemtilstand |")
