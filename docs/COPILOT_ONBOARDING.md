...
## 3. STEP-Protokollen (STEP_NA_NB_GOVERNANCE_ACTIVE 🔒)

**Alle komplekse domæner følger to-fase modellen:**

```
STEP N-A:  ANALYSE ONLY — ingen kode, kun Layer 1 ekstraktion
           Resultat i temp.md → ChatGPT reviewer
           
STEP N-B:  IMPLEMENTERING — kun efter Architect siger "approved"
           Følger green-ai SSOT patterns
           Tests med implementationen
```

**Du MÅ IKKE starte N-B uden eksplicit godkendelse fra Architect.**
