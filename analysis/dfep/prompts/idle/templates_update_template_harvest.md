...
> Domain: Templates | Capability: `update_template` | Gap type: HIGH_GAP | Date: 2026-04-17

## Task

Find ALL code paths in the **sms-service** repository responsible for:

**update_template** — Update an existing message template
...
- Look for class/method names containing: `updatetemplate`, `UpdateTemplate`, `Update`
