...
> Domain: Warnings | Capability: `list_warnings_by_profile` | Gap type: HIGH_GAP | Date: 2026-04-20

## Task

Find ALL code paths in the **sms-service** repository responsible for:

**list_warnings_by_profile** — Retrieve historical Warning records for a profile within a date range
...
- Look for class/method names containing: `listwarningsbyprofile`, `ListWarningsByProfile`, `List`
...
```json
{
  "capability_id": "list_warnings_by_profile",
  "domain": "Warnings",
  "found": true,
  "entry_point": {
