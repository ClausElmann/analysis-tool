...
> Domain: Warnings | Capability: `warning_type_management` | Gap type: HIGH_GAP | Date: 2026-04-20

## Task

Find ALL code paths in the **sms-service** repository responsible for:

**warning_type_management** — Read WarningTypes available to a profile, optionally filtered by ProfileRole
...
- Look for class/method names containing: `warningtypemanagement`, `WarningTypeManagement`, `Warning`
- SQL table names likely include: `Warnings`
...
```json
{
  "capability_id": "warning_type_management",
  "domain": "Warnings",
  "found": true,
  "entry_point": {
