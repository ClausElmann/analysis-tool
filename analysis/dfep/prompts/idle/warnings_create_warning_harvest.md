...
> Domain: Warnings | Capability: `create_warning` | Gap type: HIGH_GAP | Date: 2026-04-20

## Task

Find ALL code paths in the **sms-service** repository responsible for:

**create_warning** — Create a new Warning from an external system, attaching typed fields and recipients
...
- Look for class/method names containing: `createwarning`, `CreateWarning`, `Create`
